const projects = [
  ...
  },
  {
    ...
    details: [
      { id: 22, label: "Role", content: ["Lead Developer"]},
      { id: 23, label: "Tools", content: ["C++","OpenGL","DSCinder"]},
      { id: 24, label: "Company", content: ["Downstream"], link: "https://www.downstream.com/"},
      { id: 25, label: "Client", content: ["BSU"], link:"https://www.boisestate.edu/luminary/"},
      { id: 26, label: "Year", content:["2021"]},
    ],
  },
  {
    id: 4,
    ...
    details: [
      { id: 0, label: "Role", content: ["Lead Developer"]},
      { id: 1, label: "Tools", content: ["C++","OpenGL","DSCinder"]},
      { id: 2, label: "Company", content: ["Downstream"], link: "https://www.downstream.com/"},
      { id: 3, label: "Client", content: ["VF Corp"], link:"https://www.vfc.com/"},
      { id: 4, label: "Year", content:["2020"]},
    ],
  },
];
