...
const ProjectCard = ({data}) => {
  return (
    <div className="card shadow-xl w-full relative hover:scale-105">
      <Link to={`/projects/${data.id}`} state={{ projectData: data }}>
        <div className="group bg-accent rounded-lg">
          <img className="absolute top-0 left-0 w-full h-full group-hover:opacity-30 rounded-lg object-cover object-center" src={data.hero}/>
