    ...
    <div className="w-full bg-primary border-8 border-primary rounded-lg shadow-xl">
      <div className="card w-full relative">
        <Link to={`/projects/${data.id}`} state={{ projectData: data }}>
          <div className="group bg-accent rounded-lg aspect-5/3">
            ...
            <div className="card-body z-40 relative opacity-0 group-hover:opacity-100 w-full h-full object-center justify-center">
